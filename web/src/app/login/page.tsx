  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-6 py-12">
      ...
      <div className="w-full max-w-md rounded-3xl border border-slate-100 bg-white p-10 shadow-xl shadow-slate-200/50">
        ...
        <h1 className="mb-2 text-center text-2xl font-bold tracking-tight">ログイン</h1>
        ...
        <form className="space-y-4">
          ...
          <div>
            <label className="mb-1.5 block text-xs font-semibold text-slate-700">パスワード</label>
            <input
              type="password"
              placeholder="••••••••"
              className="w-full rounded-lg border border-slate-200 px-3.5 py-3 text-sm transition focus:border-[var(--color-primary)] focus:outline-none focus:ring-3 focus:ring-indigo-100"
          ...
          <button
            type="submit"
            className="w-full rounded-xl bg-[var(--color-primary)] py-3 text-sm font-bold text-white shadow-lg shadow-indigo-500/25 transition hover:bg-[var(--color-primary-dark)]"
          >
            ログイン
          </button>
        </form>
